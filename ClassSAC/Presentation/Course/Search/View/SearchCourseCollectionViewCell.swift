//
//  SearchCourseCollectionViewCell.swift
//  ClassSAC
//
...
final class SearchCourseCollectionViewCell: UICollectionViewCell {

    static let identifier = "SearchCourseCollectionViewCell"
    ...
    private func configureLayout() {
        thumbnailImageView.snp.makeConstraints { make in
            ...
            make.height.equalTo(contentView.snp.width).multipliedBy(0.58)
        }
    ...
    func configure(
        ...
        let likeButtonImage = cellViewModel.isLiked ? AppIcon.heartFill.image : AppIcon.heart.image
